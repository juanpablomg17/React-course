...
import { Breadcrumb,BreadcrumbItem,Button, FormGroup, Form, Label, Input, Col, Row, FormFeedback} from 'reactstrap';
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}> 
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="number" id="telnum" name="telnum" placeholder="Telephone Number" value={this.state.telnum}
                                     valid={errors.telnum === ''}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" rows="12" id="message" name="message" placeholder="type your feedback" value={this.state.message}
                                    onChange={this.handleInputChange}
                                    />
                                </Col>
                            </FormGroup>
